  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 text-slate-950 shadow-sm backdrop-blur-xl">
      <div className="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-[76px] items-center gap-3 border-b border-slate-200 sm:gap-4">
          ...
          <div className="hidden min-w-0 flex-1 items-center gap-3 md:flex">
            <button
              type="button"
              title="Current jurisdiction: Senapati, Manipur"
              aria-label="Current jurisdiction: Senapati, Manipur"
              className="inline-flex h-11 shrink-0 items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-white"
            >
              <span aria-hidden="true" className="grid h-7 w-7 place-items-center rounded-full bg-white text-base shadow-sm">⌖</span>
              <span className="hidden lg:inline">Senapati</span>
            </button>

            <div className="flex h-11 min-w-[240px] flex-1 items-center rounded-full border border-slate-200 bg-slate-100/80 p-1 shadow-inner transition focus-within:border-slate-300 focus-within:bg-white focus-within:shadow-sm">
              <span aria-hidden="true" className="pl-3 text-sm text-slate-400">⌕</span>
              <input
                ...
                placeholder="Search materials, trades, services..."
              />
              <button type="button" className="h-9 shrink-0 rounded-full bg-[#0b1b36] px-5 text-sm font-bold text-white shadow-sm transition hover:bg-[#132b52] active:scale-[0.98]">Search</button>
            </div>
          </div>
          ...
          <div className="ml-auto flex items-center gap-3 text-sm">
            {hasAccount ? (
              <form action={async () => {
                ...
                <button className="rounded-full border border-slate-200 bg-white px-4 py-2.5 font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 active:scale-[0.98]">Log out</button>
              </form>
            ) : (
              <>
